...
class RequestRepository {
  ...
  Future<PropertyRequestModel> createRequest(Map<String, dynamic> data) async {
    ...
    return PropertyRequestModel.fromJson(response.data['request'] ?? response.data);
  }

  Future<PropertyRequestModel> updateRequest(int id, Map<String, dynamic> data) async {
    final response = await _dioClient.put('${ApiEndpoints.requests}/$id', data: data);
    return PropertyRequestModel.fromJson(response.data['request'] ?? response.data);
  }
