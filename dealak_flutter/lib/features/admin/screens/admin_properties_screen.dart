...
class _AdminPropertiesScreenState extends ConsumerState<AdminPropertiesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final params = <String, dynamic>{'page': _currentPage, 'per_page': 20};
            ...
            child: propertiesAsync.when(
              data: (paginated) {
                ...
                return RefreshIndicator(
                  onRefresh: () async {
                    ref.invalidate(adminPropertiesProvider(params));
                  },
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => _PropertyListItem(
                      ...
                      isDark: isDark,
                      onEdit: () => context.push(
                        '${RouteNames.adminPropertyForm}/${properties[index].id}',
                      ),
                      onDelete: () => _confirmDelete(properties[index]),
                      onToggleFeatured: () =>
                          _toggleFeatured(properties[index]),
                    ),
                  ),
                );
              },
  ...
  Widget _buildStatusChip(String label, String value, bool isDark) {
    ...
    return FilterChip(
      ...
      selected: isSelected,
      onSelected: (selected) =>
          setState(() => _statusFilter = selected ? value : ''),
  ...
  Future<void> _confirmDelete(PropertyModel property) async {
    ...
    if (confirmed == true) {
      await ref
          .read(adminPropertyProvider.notifier)
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        Formatters.status(property.status),
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 12,
                        ),
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      color: property.isFeatured ? AppColors.secondary : null,
                    ),
